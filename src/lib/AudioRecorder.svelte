...
<div class="flex flex-col justify-center items-center">
  <button
    type="button"
    class={`m-2 inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 transition-all duration-200 ${
      recording
  ...
  {#if recordedBlob}
    <audio class="w-full" bind:this={audioRef} controls>
      <source
